...
namespace GameProject
{
    ...
    public class Projectile
    {
        ...
        public void Update(GameTime gameTime)
        {
            ...
            if (((drawRectangle.X - sprite.Width > GameConstants.WindowWidth) ||(drawRectangle.X +sprite.Width< 0)) && ((drawRectangle.Y - sprite.Height> GameConstants.WindowHeight) ||(drawRectangle.Y+ sprite.Height < 0)))
            {
                active = false;
            }
        }
