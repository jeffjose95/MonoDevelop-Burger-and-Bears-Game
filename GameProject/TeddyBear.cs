    ...
    public class TeddyBear
    {
        ...
        public void Update(GameTime gameTime)
        {
            ...
            if (elapsedShotMilliseconds > firingDelay)
            {
               ...
               firingDelay = GetRandomFiringDelay();
                Projectile TeddyProjectile = new Projectile(ProjectileType.TeddyBear,teddyProjectile, drawRectangle.X + GameConstants.TeddyBearProjectileOffset, drawRectangle.Y + GameConstants.TeddyBearProjectileOffset, GetProjectileYVelocity());
            ...
            int x, int y)
        {
            ...
            teddyProjectile = contentManager.Load<Texture2D>("Graphics//teddybearprojectile");
